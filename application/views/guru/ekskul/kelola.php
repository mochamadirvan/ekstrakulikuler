                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            <h3 class="panel-title">Data Ekskul</h3>
                            <p class="panel-subtitle">Guru / Data Ekstrakurikuler</p>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-success" onclick="dokumentasi(<?php echo $row->id_ekskul;?>)"><i class="fa fa-camera"></i> Unggah</button>
                                             ...
                                             <?php echo anchor('ekskul/data-pendaftar/'.$row->id_ekskul,'<button class="btn btn-primary"><i class="fa fa-list"></i> Lihat Pendaftar & Nilai</button>');
                                             ?>
                                            <?php echo anchor('ekskul/cetak/'.$row->id_ekskul,'<button class="btn btn-success"><i class="fa fa-print"></i> Report</button>');
                                                 ?>
                                        </td>
                                        </tr>
                                     <?php } ?>   
