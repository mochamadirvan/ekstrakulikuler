<div class="main">
			...
			<div class="main-content">
                ...
                <a href="<?php echo base_url('siswa/tambah')?>" class="act-btn">+</a>
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Guru / Data Siswa</p>
						</div>
...
<script>
    ...
    {
      save_method = 'update';
      $('#form-siswa')[0].reset(); // reset form on modals
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('.modal-footer').show();
            $('#form-siswa').attr('action','<?php echo site_url('siswa/update');?>');
        },
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open('siswa/create',array('id' => 'form-siswa'));?>
        <div class="row">
            <div class="col-md-6">
